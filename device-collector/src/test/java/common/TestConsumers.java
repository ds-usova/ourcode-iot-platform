...
public class TestConsumers {
    ...
    private KafkaConsumer<String, DeviceDeadLetter> deviceDltKafkaConsumer;
    ...
    void init() {
        this.deviceDltKafkaConsumer = createConsumer(kafkaTopics.devices() + "-dlt");
    }

    void close() {
        if (deviceDltKafkaConsumer != null) {
            deviceDltKafkaConsumer.close();
        }
    }

    public Map<String, DeviceDeadLetter> readDlt() {
        return read(deviceDltKafkaConsumer, kafkaTopics.devices() + "-dlt");
    }
