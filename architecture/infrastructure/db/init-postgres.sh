...
# Create camunda user and schema
ROUTER_MANAGER_DB_USER=${ROUTER_MANAGER_DB_USER:-router_manager_user}
ROUTER_MANAGER_DB_PASSWORD=${ROUTER_MANAGER_DB_PASSWORD:-router_manager_pass}
ROUTER_MANAGER_DB_SCHEMA=${ROUTER_MANAGER_DB_SCHEMA:-router}

initialize_schema "$ROUTER_MANAGER_DB_USER" "$ROUTER_MANAGER_DB_PASSWORD" "$ROUTER_MANAGER_DB_SCHEMA"
