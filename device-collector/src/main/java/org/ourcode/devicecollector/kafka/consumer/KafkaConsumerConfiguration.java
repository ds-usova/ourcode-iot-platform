...
public class KafkaConsumerConfiguration {
    ...
    public ConsumerRecordRecoverer deviceRecoverer(
        ...
        return new DeviceReportingRecoverer(applicationEventPublisher, new DeviceDeadLetterPublishingRecoverer(kafkaTemplate));
    }
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, Device> kafkaListenerContainerFactory(DefaultErrorHandler errorHandler) {
